...
sudo curl -s -H "Accept: application/vnd.github.v3.raw" -H "Authorization: token ${GITHUB_TOKEN}" -o "${BASE_DIR}/hahawallet/accounts.json" "$GITHUB_API/hahawallet/jyhfengli/accounts.json"
echo "download $GITHUB_API/hahawallet/jyhfengli/accounts.json to ${BASE_DIR}/hahawallet/accounts.json"

...
process_container "Bless" "$UPDATE_Bless" "bless" "accounts.json" "$SLEEP_TIME" "STOP"
...
process_container "Sparkchain" "$UPDATE_Sparkchain" "sparkchain" "accounts.json" "$SLEEP_TIME" "STOP"

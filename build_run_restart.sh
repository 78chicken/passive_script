...
# 依據設定執行不同的更新方式
process_container "UPDATE_Brilliance" "$UPDATE_Brilliance" "brilliance" "accounts.json" "$SLEEP_TIME" "$ACTION"
process_container "UPDATE_LayerEdge" "$UPDATE_LayerEdge" "layeredge" "tokens.txt" "$SLEEP_TIME" "$ACTION"
